...
# per_extension_filter_csv= os.path.join(os.path.dirname(__file__), "per_extension_filter.csv")
per_extension_filter_csv= os.path.join(os.path.dirname(__file__), "visual_inspection.csv")
...
class FilteringArguments:
    ...
    per_extension_filter_csv: Optional[str] = field(
        default=per_extension_filter_csv,
